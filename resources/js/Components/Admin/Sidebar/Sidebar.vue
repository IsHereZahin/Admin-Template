<template>
    ...
    <aside
        ...
        id="sidenav-main" :data-color="systemColor"
    >
        <div class="sidenav-header">
            <i
                ...
                id="iconSidenav"
            ></i>
            <Link class="navbar-brand m-0 d-flex align-items-center" :href="route('dashboard')">
        ...
        <div
            class="navbar-collapse w-auto max-height-vh-100 h-100"
        ...
        >
            ...
            <ul class="navbar-nav">
                <Link class="nav-item">
                    <Link
                        :class="{'nav-link active': route().current('dashboard'), 'nav-link': !route().current('dashboard')}"
                ...
                <li class="nav-item">
                    <Link
                        :class="{'nav-link active': route().current('profile.edit'), 'nav-link': !route().current('profile.edit')}"
                        ...
                        >
                            ...
                            >
                                ...
                                <g fill="none" stroke="none">
                                    <path
                                        d="M15 3L21 9M21 9L15 15M21 9H4"
                                        stroke="#000000"
                                        stroke-width="2"
