<template>
    <div class="bg-white rounded-lg shadow-md h-full flex flex-col">
        <div class="p-3 flex-1">
            <div
            :class="`bg-gradient-${systemColor} color-white rounded-lg p-4 pr-1 mb-3`"
            class="bg-gray-800 color-white rounded-lg p-4 pr-1 mb-3">
                <div class="chart">
                    <canvas ref="chartRef" height="170"></canvas>
                </div>
            </div>
            <h6 class="ml-2 mt-4 mb-0 text-lg font-semibold">Active Users</h6>
            <p class="text-sm ml-2 text-gray-600">
                (<span class="font-bold text-green-500">+23%</span>) than last week
            </p>
...
onMounted(() => {
    createChart(chartRef.value, "bar", {
        labels: ["M", "T", "W", "T", "F", "S", "S"],
        datasets: [
            {
                label: "Active Users",
                data: [50, 120, 200, 300, 150, 100, 400],
                borderRadius: 4,
                maxBarThickness: 10,
            },
        ],
